...
public class PhotoWallActivity extends Activity implements AbsListView.OnScrollListener {

    private List<String> mUrlList = new ArrayList<String>();
    private Drawable mDefaultDrabale = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.photo_wall_gridview);

        mImageLoader = ImageLoader.build(PhotoWallActivity.this);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null) {
                convertView = View.inflate(PhotoWallActivity.this, R.layout.phonto_gridview_item, null);
            ...
            if (!url.equals(tag)) {
                imageView.setImageDrawable(mDefaultDrabale);
            }
